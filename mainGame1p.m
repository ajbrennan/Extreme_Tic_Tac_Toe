...
p2win = uicontrol('Style', 'pushbutton', 'String', 'Computer won', 'Position', [301 526 150 50], 'FontSize', 20, 'Callback', @p2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function p2(source,eventdata)
        ...
        if winner2 == 1
            ...
            set(playGame, 'Style', 'text', 'String', 'Computer wins!!!', 'Position', [1 513 150 50])
        end
    end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
